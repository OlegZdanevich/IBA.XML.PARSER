...
public class AuthorsLastNameComparatorTest {
    ...
    AuthorsLastNameComparator comparator = null;
    ...
    public void setUp() {
        ...
        comparator = new AuthorsLastNameComparator();

        book1=new Book(new Person("OLEG","Zdanevich"),"blabla",element1);
        book2=new Book(new Person("OLEG","AZdanevich"),"alabla",element2);
    }
