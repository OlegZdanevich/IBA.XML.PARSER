...
public class AuthorsFisrtNameComparatorTest {
    ...
    AuthorsFisrtNameComparator comparator = null;
    ...
    public void setUp() {
        ...
        comparator = new AuthorsFisrtNameComparator();

        book1=new Book(new Person("OLEG","Zdanevich"),"blabla",element1);
        book2=new Book(new Person("ALEG","AZdanevich"),"alabla",element2);
    }
