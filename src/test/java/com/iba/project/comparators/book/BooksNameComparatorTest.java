...
public class BooksNameComparatorTest {
    ...
    BooksNameComparator comparator = null;
    ...
    public void setUp() {
        ...
        comparator = new BooksNameComparator();

        book1=new Book(new Person("OLEG","Zdanevich"),"blabla",element1);
        book2=new Book(new Person("OLEG","Zdanevich"),"alabla",element2);
    }
